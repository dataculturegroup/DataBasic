...
class CultureAskQuestions(CultureForm, Form):
    feedback = StringField(
            description={'placeholder': _('What worked? What didn\'t? How could we improve this activity guide or our videos? Did anyone make something amazing? How is this fitting into your other efforts to build a data culture?')},
            widget=TextArea())
    ...
    def __init__(self):
        super(CultureAskQuestions, self).__init__()

class CultureConvinceMe(CultureForm, Form):
    feedback = StringField(
            description={'placeholder': _('What worked? What didn\'t? How could we improve this activity guide or our videos? Did anyone make something amazing? How is this fitting into your other efforts to build a data culture?')},
            widget=TextArea())
    ...
    def __init__(self):
        super(CultureConvinceMe, self).__init__()